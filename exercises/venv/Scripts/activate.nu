...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'G:\Metropolia\PyCharmProjects\Python-code\exercises\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'G:\Metropolia\PyCharmProjects\Python-code\exercises\venv\Scripts\deactivate.nu'
